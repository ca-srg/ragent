...
func (r *Reader) readWithConfig(reader io.Reader, sourcePath string, fileConfig *FileConfig) ([]*pkgdomain.FileInfo, error) {
...
func extractMetadata(row []string, headers []string, detector *ColumnDetector, fileConfig *FileConfig) pkgdomain.DocumentMetadata {
