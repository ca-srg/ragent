...
func (f *Fetcher) Fetch(ctx context.Context) ([]*pkgdomain.FileInfo, error) {
...
func (f *Fetcher) fetchSheet(ctx context.Context, cfg SheetConfig) ([]*pkgdomain.FileInfo, error) {
	// Get sheet data
...
func (f *Fetcher) extractMetadata(row []string, headers []string, cfg SheetConfig, detector *ColumnDetector) pkgdomain.DocumentMetadata {
